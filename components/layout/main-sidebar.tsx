        ...
        <>
          <div className="flex items-center h-16 px-3 border-b">
            <div className="flex items-center">
              {!isCollapsed && (
                <h1 className="text-lg font-semibold ml-2 mr-2">
                  Vyoma Innovus
                </h1>
              )}
              {isCollapsed && (
                <div className="w-10 h-10 rounded-full bg-primary flex items-center justify-center text-white font-semibold text-xl">
                  V
                </div>
              )}
            </div>
